...
# Run a two-way ANOVA with Race and ISI_total (as an example)
# Replace 'ISI_total' with the variable of interest from your heatmap
result <- aov(ISI_total ~ Race + GCTI_total + Race:GCTI_total, data = data_subset)
summary(result)
...
three_way_anova_result <- aov(ISI_total ~ Race * Group + Race * ISI_total + Group * ISI_total + Race * Group * ISI_total, data = data)
